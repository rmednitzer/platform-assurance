...
**Status:** DRAFT — requirement IDs are [S,80]; verify against current official texts and Austrian national transposition before audit submission.
...
*All requirement mappings [S,80] unless noted. Verify against current official texts (EUR-Lex), Austrian NISG 2026 transposition (effective 2026-10-01), and EDPB guidelines before audit submission. CRA application dates and harmonised standards: Unknown — verify on EUR-Lex.*
