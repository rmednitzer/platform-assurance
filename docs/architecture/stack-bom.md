...
|---|----------|------|---------|
| — | **Stack BOM** | `stack-bom.md` | Tiered component inventory (§1–§17) |
| A | License Audit | `stack-bom-license-audit.md` | OSS/BSL/proprietary per component |
| B | Regulatory Mapping | `stack-bom-regulatory-mapping.md` | NIS2/CRA/GDPR → stack controls + gap analysis |
| C | Evidence Pipeline | `stack-bom-evidence-pipeline.md` | Evidence generation, signing, storage (MinIO WORM + OpenSearch catalogue) |
| D | AI & API Management | `stack-bom-ai-api.md` | AI workload tiers + API gateway + LLM gateway + OWASP LLM |
| E | Observability + IAM | `stack-bom-observability-iam.md` | Request-to-evidence flow + IAM architecture |
| F | ISMS Policy Set | `stack-bom-isms-policies.md` | 10 policies + supporting docs, cross-referenced to NIS2/CRA/GDPR/ISO 27001/SCF/Austrian law |
