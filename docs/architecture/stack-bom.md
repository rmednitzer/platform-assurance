...
- **Boundary enforced**: which PIAL (Physics-Informed Abstraction Layer) enforcement point this component serves, if any — see Appendix D (AI & API Management) for the full PIAL definition
- **Tier**: T0–T3
